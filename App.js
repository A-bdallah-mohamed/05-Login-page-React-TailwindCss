...
function App() {
  ...
  return (
    ...
    <div className={isitlogin ? `right-0 absolute w-[50%] bg-lime-400 h-[100%] transition-all duration-1000 ease-in-out  overflow-hidden z-40  flex items-center justify-center` : ' overflow-hidden right-[50%] absolute w-[50%] bg-lime-400 h-[100%] transition-all duration-1000 ease-in-out z-40 flex items-center justify-center'} >
      ...
      <div  className={isitlogin ? ` flex items-center justify-center translate-y-[200%]  top-[65%] translate-x-[-5%] transition-all duration-1000 ease-in-out w-[400px] h-[40px]` : 'translate-x-[5%] flex items-center justify-center  transition-all duration-1000 ease-in-out translate-y-[200%] h-[40px] top-[65%] w-[450px]  ' }>
      <div onClick={handleclick} className={isitlogin ? `overflow-hidden  top-[65%] left-[200px] hover:w-[165px] transition-all duration-1000 ease-in-out whitespace-nowrap bg-lime-400 border-[3px] border-white rounded-2xl w-[155px] h-[40px] hover:h-[50px] hover:bg-lime-200 cursor-pointer` : 'hover:h-[50px] overflow-hidden h-[40px] whitespace-nowrap  top-[65%] left-[33%] bg-lime-400 border-[3px] border-white rounded-2xl w-[250px] hover:w-[260px] transition-all duration-1000 ease-in-out hover:bg-lime-200 cursor-pointer' }>
        </div>
