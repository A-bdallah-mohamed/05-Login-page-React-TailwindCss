...
function App() {
  ...
  return (
    ...
    <div className={isitlogin ? `right-0 absolute w-[50%] bg-lime-400 h-[100%] transition-all duration-1000 ease-in-out  overflow-hidden z-40 ` : ' overflow-hidden right-[50%] absolute w-[50%] bg-lime-400 h-[100%] transition-all duration-1000 ease-in-out z-40'} >
      <div className={isitlogin ? `text-center absolute top-[30%] right-[16.5%] transition-all duration-1000 ease-in-out whitespace-nowrap ` : 'text-center whitespace-nowrap absolute top-[30%] right-[-155%]  transition-all duration-1000 ease-in-out' }>
        <div className='text-6xl'>Hello, Friend!</div>
        <div><br />To keep connected with us please<br /> enter your personal info</div>
      </div>
      <div className={isitlogin ? `text-center absolute top-[30%] left-[-150%] transition-all duration-1000 ease-in-out whitespace-nowrap ` : 'text-center whitespace-nowrap absolute top-[30%] left-[19%]  transition-all duration-1000 ease-in-out' }>
    ...
    <div className={isitlogin ? ` px-[100px] text-center whitespace-nowrap absolute left-[-50%] transition-all duration-1000 ease-in-out` : ' px-[100px] text-center whitespace-nowrap absolute left-[-13%] transition-all duration-1000 ease-in-out'}>
